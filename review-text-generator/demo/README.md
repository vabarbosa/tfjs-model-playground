...
1. Point your web server to the `review-text-generator` directory in the cloned repo
    ...
    >   1. From the Web Server, click **CHOOSE FOLDER** and browse to the `review-text-generator` directory in the cloned repo
    >   1. Start the Web Server
    >   1. Make note of the **Web Server URL(s)** (e.g., http://127.0.0.1:8887)
    >   
    > - using the Python **HTTP server** module
    >   
    >   1. From a terminal shell, go to the `review-text-generator` directory in the cloned repo
